 ...
 * @author marechay
 */
public class RenaultZoeR90_41 implements Car {
    private final static double carWeight = 1480;

    private final static double scx = 0.75;

    private final static double battery = 41000;
    ...
    public static final String NAME = "Zoe R90 41kWh";
